...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/Mar01/rice.git" && repobranch="master"
#[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/LukeSmithxyz/LARBS/master/archi3/progs.csv"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/Mar01/MARBS/master/progs.csv"
